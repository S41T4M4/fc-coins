...
namespace EAFCCoinsManager.Migrations
{
    ...
    [Migration("20250916012034_AddMissingColumnsToPlataforma")]
    partial class AddMissingColumnsToPlataforma
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.Pedido", b =>
                {
                    ...
                    b.Property<int?>("VendedorOfertaid_oferta")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("VendedorOfertaid_oferta");
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.Plataforma", b =>
                {
                    ...
                    b.Property<decimal>("taxa_por_100k")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.VendedorOferta", b =>
                {
                    b.Property<int>("id_oferta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("id_oferta"));
                    ...
                    b.Property<decimal>("preco_por_100k")
                        .HasColumnType("numeric");

                    b.Property<decimal>("quantidade_coins")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("taxa_plataforma")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.Pedido", b =>
                {
                    b.HasOne("EAFCCoinsManager.Models.VendedorOferta", null)
                        .WithMany("Pedidos")
                        .HasForeignKey("VendedorOfertaid_oferta");
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.VendedorOferta", b =>
                {
                    b.HasOne("EAFCCoinsManager.Models.Usuarios", "Vendedor")
                        .WithMany("OfertasVendedor")
                        .HasForeignKey("id_vendedor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EAFCCoinsManager.Models.Plataforma", "Plataforma")
                        .WithMany("OfertasVendedores")
                        .HasForeignKey("plataforma_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.Plataforma", b =>
                {
                    ...
                    b.Navigation("OfertasVendedores");
                });
