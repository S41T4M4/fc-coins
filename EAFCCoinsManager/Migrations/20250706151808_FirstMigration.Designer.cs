...
namespace EAFCCoinsManager.Migrations
{
    ...
    [Migration("20250706151808_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.ItemCarrinho", b =>
                {
                    ...
                    b.Property<int>("Carrinhoid_carrinho")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Carrinhoid_carrinho");
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.Moeda", b =>
                {
                    ...
                    b.Property<int?>("Plataformaid_plataforma")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Plataformaid_plataforma");
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.ItemCarrinho", b =>
                {
                    b.HasOne("EAFCCoinsManager.Models.Carrinho", "Carrinho")
                        .WithMany("Itens")
                        .HasForeignKey("Carrinhoid_carrinho")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EAFCCoinsManager.Models.Moeda", b =>
                {
                    b.HasOne("EAFCCoinsManager.Models.Plataforma", null)
                        .WithMany("Moedas")
                        .HasForeignKey("Plataformaid_plataforma");
                });
